...
import { parseInequality, levelIneq } from "./parser";
...
export default function InequalityGame() {
  ...
  function addCustom() {
    const p = parseInequality(customInput);
    if (!p) {
    ...
    <div className="min-h-screen bg-surface text-text font-sans p-5 sm:p-6">
      <div className="max-w-xl mx-auto">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-xs text-text-muted mb-4">Find the range on the number line</p>
