...
import { parseDistribution, levelDistEq } from "./parser";
...
export default function DistributionGame() {
  ...
  function addCustom() {
    const p = parseDistribution(customInput);
    if (!p) {
      setCustomError("Try: 3(2x+1)=21, 4(n+2)=28");
      return;
    }
    setCustomError("");
    setLevels((l) => [...l, p]);
    ...
    <div className="min-h-screen bg-surface text-text font-sans p-5 sm:p-6">
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-5">
          ...
          <p className="text-xs text-text-muted mb-4">Distribute, then solve</p>
